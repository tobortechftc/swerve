...
//        @Override
//        public String value() {
//            String str = String.format("%f / %f", robot.rangeSensorFrontLeft.getDistance(DistanceUnit.CM), robot.rangeSensorFrontRight.getDistance(DistanceUnit.CM));
//            return str;
//        }
//    }
...
////                isOverDistance = robot.rangeSensorFrontRight.getDistance(DistanceUnit.CM) >= driveDistance;
////                if (isOverDistance) {
////                    driveTT(-1 * power, -1 * power);
////                    mode++;
////                }
////            } else if (mode == 3) { // Drives backwards to compensate
////                isUnderDistance = robot.rangeSensorFrontRight.getDistance(DistanceUnit.CM) <= driveDistance;
////                if (isUnderDistance) {
