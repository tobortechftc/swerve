...
public class SwerveDriveHardware {
    ...
    final static double IMU_ROTATION_RATIO_L = 0.75; // 0.84; // Ratio of IMU Sensor Left turn to prevent overshooting the turn.
    final static double IMU_ROTATION_RATIO_R = 0.72; // 0.84; // Ratio of IMU Sensor Right turn to prevent overshooting the turn.
    ...
    final static double SV_GLYPH_GRABBER_BOTTOM_INIT = 0.689;
    final static double SV_GLYPH_GRABBER_BOTTOM_OPEN = 0.58;
    final static double SV_GLYPH_GRABBER_BOTTOM_HALF_CLOSED = 0.53;
    final static double SV_GLYPH_GRABBER_BOTTOM_CLOSED = 0.405;
    final static double SV_RELIC_GRABBER_INIT = 0.54;
    final static double SV_RELIC_GRABBER_CLOSE = 0.43;
    final static double SV_RELIC_GRABBER_OPEN = 0.7;
    final static double SV_RELIC_ARM_INIT = 0.2;
    ...
    final static double SV_RELIC_ARM_DOWN_R = 0.3; // down and ready for releasing
    ...
    static double SERVO_FL_TURN_POSITION = SERVO_FL_FORWARD_POSITION - (CRAB_DIFF_DEC/2);
    static double SERVO_FR_TURN_POSITION = SERVO_FR_FORWARD_POSITION + (CRAB_DIFF_INC/2);
    static double SERVO_BL_TURN_POSITION = SERVO_BL_FORWARD_POSITION + (CRAB_DIFF_INC/2);
    static double SERVO_BR_TURN_POSITION = SERVO_BR_FORWARD_POSITION - (CRAB_DIFF_DEC/2);
