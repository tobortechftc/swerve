...
public class SwerveDriveHardware {
    ...
    static double NB_LEFT_SV_DIFF = 0.005;
    static double NB_RIGHT_SV_DIFF = 0.008;
    ...
    void initialize_newbot() {
        ...
        SERVO_FL_TURN_POSITION = NB_SERVO_FL_FORWARD_POSITION  - (SPOT_TURN_ANGLE_OFFSET);
        SERVO_FR_TURN_POSITION = NB_SERVO_FR_FORWARD_POSITION  + (SPOT_TURN_ANGLE_OFFSET);
        SERVO_BL_TURN_POSITION = NB_SERVO_BL_FORWARD_POSITION  + (SPOT_TURN_ANGLE_OFFSET);
        SERVO_BR_TURN_POSITION = NB_SERVO_BR_FORWARD_POSITION  - (SPOT_TURN_ANGLE_OFFSET);
